...
\title[Projekt FHL Winter 13]{Zwischenpraesentation}
...
Sie ist dabei jedoch umstaendlich, und nur mueig dokumentiert.\pause
\linebreak
Deswegen: Entwicklung eines Wrappers fuer eine komfortablere Nutzung des EEG Headsets.
...
Es wurde ebenfalls eine allgemeine Schnittstelle definiert, die es ermoeglicht mit minimalem Aufwand unterschiedliche EEG Headsets zu nutzen

\end{frame}


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Torcs} % die sections sind hier nur zum Strukturieren des Vortrags!!
%% der Name der section taucht nur im Inhaltsverzeichnis und im linken Rand auf.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Verteilte Systeme mit OSC-Kopplung}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
