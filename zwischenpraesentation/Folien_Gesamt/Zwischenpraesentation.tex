...
\begin{frame}
  \frametitle{Emotiv Cognitiv Suite}
  
  \pgfimage[width=\textwidth]{cognitiv.png}
...
Die Kinect ist ein Sensor für Bilderfassung.\\
...
\movie[externalviewer]{\includegraphics[width=\textwidth]{Snapshot_linkes_Bein.png}} {Video_linkes_Bein_edit.mov} %% Snapshot ändern!!!!
\end{frame}
...
\pgfimage[width=\textwidth]{linplot_linkes_bein_markiert.png}
...
\begin{frame}
  \frametitle{Betrachtung des Spektrogramms}
...
\begin{frame}
  \frametitle{Thetabandanalyse}
    ...
    \pgfimage[width=0.8\textwidth]{AufbereitungBlockdiagram.png}
...
Sie ist dabei jedoch umständlich, und nur mäßig dokumentiert.
\linebreak
...
\begin{frame}
\begin{center}
\frametitle{Mit den Händen malen und mit den Gedanken färben}       
\movie[externalviewer]{\includegraphics[width=0.60\textwidth]{code.PNG}} {Abstarkte-Kunst.wmv} %% Snapshot ?ndern!!!!
\end{center}
\end{frame}
...
\begin{center}
\movie[externalviewer]{\includegraphics[scale=0.4]{Audio.PNG}} {CarlosSantanaEuropa(cover).wmv} %% Snapshot ?ndern!!!!
\end{center}
\end{frame}
