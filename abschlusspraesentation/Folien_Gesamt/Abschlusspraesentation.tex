...
Er liefert die Daten für den OSC-Server.

\end{frame}

\begin{frame}
  \frametitle{Emotiv Epoc API Wrapper Funktionalitäten}
...
Vergangene Woche: Besuch von Vincent Michalke, Student für Komposition an der HMTM Hannover.
